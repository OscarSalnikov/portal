...
Адаптивный HTML + CSS шаблон для 4 страниц: `index`, `dashboard`, `kanban`, `profile`. Все экраны используют единую сетку (макс. 1200 px), общие цвета и плавные анимации (`fadeIn`, `fadeInUp`, `slideIn`). В комплекте: базовые ассеты (`/assets`) и глобальный стиль `styles.css`.
...
- `assets/` — SVG аватар и питомец (можно заменить своими иллюстрациями).
